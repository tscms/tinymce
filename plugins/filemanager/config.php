...
//$root = rtrim($_SERVER['DOCUMENT_ROOT'],'/index.php/'); // don't touch this configuration
...
$upload_dir = '/uploads/libary/'; // path from base_url to upload base dir
$current_path = '../../../../uploads/libary/'; // relative path from filemanager folder to upload files folder
